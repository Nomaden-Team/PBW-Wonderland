...
<head>
    ...
    <title>Login - Wonderland Samarinda</title>
...
<style>
    ...
    <div class="auth-top-subtitle">Login Pengunjung</div>
    ...
    <div class="auth-card">
        ...
        <form action="index.php?page=login_process" method="POST">
            ...
            <button type="submit" class="row auth-btn-submit">Login</button>
        </form>
...
<script>
    ...
    const popupConfig = {
        error:   { icon:'❌', iconBg:'#FCEBEB', title:'Login Gagal',                  btn:'#C0392B', btnText:'Coba Lagi' },
        csrf:    { icon:'⚠️', iconBg:'#FAEEDA', title:'Permintaan Tidak Valid',        btn:'#C0392B', btnText:'Muat Ulang' },
        success: { icon:'✓',  iconBg:'#EAF3DE', title:'Login Berhasil!',               btn:'#27ae60', btnText:'Lanjutkan' },
