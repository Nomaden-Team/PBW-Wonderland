    ...
    <div class="container">
        ...
        <div class="collapse navbar-collapse" id="navbarNav">
            <ul class="navbar-nav ms-auto align-items-center gap-lg-3">
                ...
                <li class="nav-item"><a class="nav-link active" href="index.php#attraction">Attraction</a></li>
            ...
            <div class="d-flex align-items-center gap-3 ms-lg-4 mt-3 mt-lg-0">
                ...
                <?php else: ?>
                    <a href="index.php?page=login" class="btn-login-figma fw-bold px-4">Login</a>
                <?php endif; ?>
            </div>
        </div>
    </div>
...
<div class="detail-hero">
    <div class="detail-hero-bg" style="background-image: url('<?= file_exists(__DIR__ . '/../../../../uploads/wahana/' . $wahana['foto']) ? 'uploads/wahana/' . $wahana['foto'] : 'assets/wahana/' . $wahana['foto'] ?>')"></div>
    <div class="container detail-hero-content">
        <div class="detail-breadcrumb">
            <a href="index.php">Home</a>
            <span>›</span>
            <a href="index.php#attraction">Attractions</a>
            <span>›</span>
            ...
            <div class="col-lg-8">
                ...
                <div id="ulasan-wahana" class="mt-5">
                    ...
                    <div class="row g-3 mb-4">
                        <?php foreach ($ulasan_wahana as $idx => $u):
                                    ...
                                    <div class="flex-grow-1">
                                        <div class="d-flex justify-content-between align-items-start">
                                            <div>
                                                <div class="d-flex align-items-center gap-2">
                                                    ...
                                                    <?php if ($isForeign): ?>
                                                    <span class="ulasan-lang-badge"><i class="bi bi-globe2"></i> Tourist</span>
                                                    <?php endif; ?>
                                                </div>
                                            ...
                                            <div class="d-flex flex-column align-items-end gap-1">
                                                ...
                                                <span class="ulasan-verified"><i class="bi bi-patch-check-fill me-1"></i>Verified</span>
                                            </div>
                                        </div>
                                        ...
                                        <div class="ulasan-translated-box" id="translated-<?= $idx ?>">
                                            <div class="ulasan-translated-label">
                                                <i class="bi bi-translate"></i> Terjemahan Indonesia
            ...
            <div class="col-lg-4">
                <div style="position:sticky; top:90px; z-index:10;">
                    <div class="detail-price-card">
                        <p class="detail-price-label"><i class="bi bi-tag-fill"></i> Harga Tiket</p>
                        <div class="detail-price-amount">Rp <?= number_format($wahana['harga'], 0, ',', '.') ?></div>
                        <p class="detail-price-per">per orang</p>
                    </div>
...
<section class="other-wahana-section">
    <div class="container">
        ...
        <div class="row g-4">
            ...
            <div class="col-md-4">
                <a href="index.php?page=detail_wahana&id=<?= $lain['id'] ?>" class="other-wahana-card">
                    <div class="card-img-wrap">
                        <img src="<?= file_exists(__DIR__ . '/../../../../uploads/wahana/' . $lain['foto']) ? 'uploads/wahana/' . $lain['foto'] : 'assets/wahana/' . $lain['foto'] ?>"
                             alt="<?= htmlspecialchars($lain['nama']) ?>">
                    </div>
                    <div class="other-wahana-body">
                        <div class="other-wahana-name"><?= htmlspecialchars($lain['nama']) ?></div>
                        <div class="other-wahana-price">Rp <?= number_format($lain['harga'], 0, ',', '.') ?></div>
                    </div>
                </a>
            </div>
            <?php endforeach; ?>
        ...
        <div class="row gy-4 mb-4">
            ...
            <div class="col-lg-3 col-md-6">
                ...
                <ul class="footer-links list-unstyled">
                    ...
                    <li><a href="index.php#attraction">Attractions</a></li>
