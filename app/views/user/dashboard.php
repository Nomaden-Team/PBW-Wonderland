...
<main class="ud-main">
    ...
    <div class="ud-topbar">
        ...
        <div class="ud-topbar-left">
            ...
            <div>
                <h1 class="ud-page-title">Dashboard Pengunjung</h1>
        ...
        <?php if (!empty($reservasis ?? [])): ?>
            <div class="ud-reservasi-list">
                <?php foreach ($reservasis as $r): ?>
                    <?php $st = $r['status'] ?? 'terjadwal'; $stLabel = ['terjadwal'=>'Dikonfirmasi','selesai'=>'Completed','dibatalkan'=>'Dibatalkan','pending'=>'Menunggu']; $stClass = ['terjadwal'=>'confirmed','selesai'=>'completed','dibatalkan'=>'cancelled','pending'=>'pending']; ?>
                    <div class="ud-reservasi-item">
                        ...
                        <div class="ud-reservasi-meta">
                            ...
                            <span class="ud-meta-item">
                                ...
                                <span class="ud-meta-label">Jumlah</span> <?= $r['jumlah_peserta'] ?> Orang
                            </span>
                            <?php endif; ?>
                        </div>
                    </div>
...
function hideComingSoon(e){if(!e||e.target===document.getElementById('comingSoonModal')){document.getElementById('comingSoonModal').classList.remove('active');}}
