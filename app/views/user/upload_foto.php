...
<head>
    ...
    <title>Upload Foto - Wonderland Samarinda</title>
...
<main class="ud-main">
    <div class="ud-topbar">
        ...
        <div class="ud-topbar-left">
            ...
            <div>
                <h1 class="ud-page-title">Upload Foto Kunjungan</h1>
    ...
    <?php
    $totalApproved = count(array_filter($fotos ?? [], fn($f) => ($f['status'] ?? '') === 'approved'));
    $totalPending  = count(array_filter($fotos ?? [], fn($f) => ($f['status'] ?? '') === 'pending'));
    ...
    <div class="ud-stats-row ud-stats-3">
        <div class="ud-stat-card">
            <div class="ud-stat-info">
                ...
                <div class="ud-stat-num"><?= $totalApproved ?></div>
            </div>
        ...
        <div class="ud-stat-card">
            <div class="ud-stat-info">
                ...
                <div class="ud-stat-num"><?= $totalPending ?></div>
            </div>
    ...
    <div class="ud-card">
        ...
        <?php else: ?>
            <div class="ud-empty-state ud-empty-large">
                ...
                <p class="ud-empty-desc">Upload foto kunjungan Anda untuk berbagi momen seru!</p>
                <button class="ud-btn-red" onclick="document.getElementById('inputFoto').click()">
                    <svg width="15" height="15" fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24"><path d="M21 15v4a2 2 0 01-2 2H5a2 2 0 01-2-2v-4"/><polyline points="17,8 12,3 7,8"/><line x1="12" y1="3" x2="12" y2="15"/></svg>
                    Upload Foto Pertama
                </button>
